...
<head>
    ...
    <title>Installation | Measurement Systems Limited</title>
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="box">
                <div class="box-header box-header-background with-border">
                    <h3 class="box-title">Measurement Systems Limited | Create User Login</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="callout callout-success">
                        <h3>Sparking!</h3>
                        <h4>Measurement Systems Limited Successfully Installed.</h4>
                    </div>
